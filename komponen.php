            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    include("cons2.php");
                    $query = $pdo->prepare("SELECT k.`nama`,k.`spec`,r.`kd_ring`,k.`satuan`,k.`harga` FROM komponen_ring kr INNER JOIN komponen k ON kr.`kd_komponen`=k.`kd_komponen` INNER JOIN ring r ON kr.`kd_ring`=r.`kd_ring`");
                    $query->execute();
                    ?>
